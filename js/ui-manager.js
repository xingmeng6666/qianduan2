...
export class UIManager {
    ...
    initUI() {
        ...
        if (song) {
            ...
            // 初始化唱针状态为暂停
            this.needle.classList.add('paused');
        }
    }
    ...
    updateCDAnimation(isPlaying) {
        this.cdContainer.classList.remove('playing', 'paused');
        this.needle.classList.remove('playing', 'paused');
        
        if (isPlaying) {
            this.cdContainer.classList.add('playing');
            this.needle.classList.add('playing');
        } else {
            this.cdContainer.classList.add('paused');
            this.needle.classList.add('paused');
        }
    }
